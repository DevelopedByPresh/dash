  ...
  return (
               ...
               <Grid sx={{ mt: -1 }} size={12}>
                ...
                <Stack direction="row" sx={{ gap: 2, alignItems: 'baseline', justifyContent: 'space-between' }}>
                  <FormControlLabel
                    ...
                    label={<Typography   color="#2C2C31" sx={{fontSize:10}}>I agree to terms & conditions</Typography>}
                  />
    ...
    <Grid size={12}>
                ...
                >
                  ...
                  />
                  <Typography
                    sx={{ fontSize: 10, color: "#2D00F7", cursor: "pointer" }} onClick={()=>navigate('/ResetPassword')}
                  >
                    Forgot Password?
                  </Typography>
                </Box>
